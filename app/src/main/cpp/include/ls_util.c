 ...
 */
    ...
    // ByteSizedFox: i removed this while loop because when faking the pipe,
    // it's not really required to wait in a loop
	// impacts of this are seemingly none, but this may be a place to look in the future
    // removed to fix android hanging bug
