package dev.bytesizedfox.microdectalktest;

import static dev.bytesizedfox.microdectalktest.App.shareAudioFile;
import static dev.bytesizedfox.microdectalktest.App.writeWavFile;
...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    public static native short[] TextToSpeechStart(String text, boolean enableCallback);
    ...
    public static native void TextToSpeechSync(int rate);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tts = new TextToSpeech(this, this, "dev.bytesizedfox.microdectalktest");
    ...
    public boolean onOptionsItemSelected( @NonNull MenuItem item ) {
        ...
        if (id == R.id.share || id == R.id.export) {
            ...
            samples = TextToSpeechStart(text, false);
        }
        if (id == R.id.share) {
            try {
