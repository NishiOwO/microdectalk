...
// function prototypes
void status_clear_update(unsigned short bits);
int reset_spc();
void status_set_update(unsigned short bits);
void status_set(unsigned short bits);
...
void status_clear(unsigned short bits)
{
//	unsigned int flags;
...
void status_abs(unsigned short bits)
{
//	unsigned int flags;
...
void status_toggle(unsigned short bits)
{
//	unsigned int flags;
...
int status_abs_update(unsigned short bits)
{
//	unsigned int flags;
...
int status_toggle_update(unsigned short bits)
{
//	unsigned int flags;
